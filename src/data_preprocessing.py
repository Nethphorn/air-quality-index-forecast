...
# 1. Load the data using our standardized loader
...
# 3. Split the data chronologically BEFORE scaling to avoid data leakage
n = len(df)
...
# This ensures the model doesn't know the min/max of the future data.
scaler = MinMaxScaler()
scaler.fit(train_df)
...
WINDOW_SIZE = 24  # Use the last 24 hours to predict the 25th hour
BATCH_SIZE = 32   
